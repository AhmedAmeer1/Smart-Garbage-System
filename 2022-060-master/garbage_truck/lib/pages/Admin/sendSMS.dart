...
class _SendSMSState extends State<SendSMS> {
  ...
  Future<void> _sendSMS(List<String> recipients) async {
    try {
      ...
      db.UpdateRouteAssign( widget.routeId ,"AssigntoDriver").then((value) => {
      ...
      context,
      MaterialPageRoute(
      builder: (context) => CalculateRouteMap(


          destinationLat:widget.destinationLat ,destinationLng:widget.destinationLng
      ))))
      ...
      //     MaterialPageRoute(
      //         builder: (context) => CalculateRouteMap(
      //           start: 'rajagiriya',destination:widget.routeName
      //             ))));
      //
      //
        ...
        body: ListView(
          children: <Widget>[
            Container(
              ...
              child: Icon(Icons.message, size: 250, color: Colors.grey),
            )),
            SizedBox(height: 80),
            if (people.isEmpty)
